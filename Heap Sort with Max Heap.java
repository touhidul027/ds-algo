...
class MaxHeap {
    ...
    public void sort () {
        int tempSize = this.currentSize;
        for(int j=currentSize-1; j >= 0; j--) {
            Node biggestNode = this.remove(); // remove from heap and
            // System.out.println("removed :" + biggestNode.getKey());
            this.insertAt(j, biggestNode); // store at array end
        }
...
public class MainDriver {
    public static void main(String[] agrs) {
        ...
        theHeap.insert(10);
        theHeap.insert(90);
        System.out.print("Display unsorted :");
        theHeap.displayHeap();
        theHeap.sort();
        System.out.print("Display as sorted :");
