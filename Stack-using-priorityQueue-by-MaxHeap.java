// implementing Stack using Priority Queue(Max Heap)
...
public class MainDriver {
    ...
    public static void main(String[] agrs) {
        System.out.println("Welcome to Stack Implementation build with Priority Queue(Maxheap");
        HeapPriorityQ theHeapPriorityQueueAsStack = new HeapPriorityQ(31);
        boolean success;
        System.out.println("Number Serial : 70 , 40 , 50, 20 , 60 , 100 , 80 , 30 , 10 , 90" );
        theHeapPriorityQueueAsStack.insert(70);
        theHeapPriorityQueueAsStack.insert(40);
        theHeapPriorityQueueAsStack.insert(50);
        theHeapPriorityQueueAsStack.insert(20);
        theHeapPriorityQueueAsStack.insert(60);
        theHeapPriorityQueueAsStack.insert(100);
        theHeapPriorityQueueAsStack.insert(80);
        theHeapPriorityQueueAsStack.insert(30);
        theHeapPriorityQueueAsStack.insert(10);
        theHeapPriorityQueueAsStack.insert(90);
        theHeapPriorityQueueAsStack.remove(); //remove 90
        theHeapPriorityQueueAsStack.displayStack();// it should display all numbers except 90
        theHeapPriorityQueueAsStack.remove(); // remove 10
        theHeapPriorityQueueAsStack.displayStack();//it should display all numbers except 10
        theHeapPriorityQueueAsStack.remove(); // remove 30
        theHeapPriorityQueueAsStack.displayStack();//it should display all numbers except 30
    }
}
